...
Apply the following systems security engineering principles to the development or modification of the system and system components: {{ insert: param, A.03.16.01.ODP.01 }}.

## Control Assessment Objective

{{ insert: param, A.03.16.01.ODP.01 }} are applied to the development or modification of the system and system components.
