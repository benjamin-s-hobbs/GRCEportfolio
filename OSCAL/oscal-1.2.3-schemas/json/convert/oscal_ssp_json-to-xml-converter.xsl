...
<!-- JSON to XML conversion: pipeline -->
   ...
   <!-- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ -->
   <!-- METASCHEMA: OSCAL System Security Plan (SSP) Model (version 1.2.3) in namespace "http://csrc.nist.gov/ns/oscal/1.0"-->
   ...
   <xsl:template match="(j:array[@key='party-uuids']/j:string | j:string[@key='party-uuid'])">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:string[@key='uuid']"
                  priority="1"><!-- XML match="system-security-plan/@uuid" -->
      <flag in-json="string"
             as-type="uuid"
             name="uuid"
             key="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='roles']/j:map/j:string[@key='id']"
                  priority="6"><!-- XML match="system-security-plan/metadata/role/@id" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='roles']/j:map/j:string[@key='id']"
                  mode="keep-value-property"
                  priority="6"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:string[@key='uuid']"
                  priority="6"><!-- XML match="system-security-plan/metadata/location/@uuid" -->
      <flag in-json="string"
             as-type="uuid"
             name="uuid"
             key="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:array[@key='telephone-numbers']/j:map/j:string[@key='type'] | j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:array[@key='telephone-numbers']/j:map/j:string[@key='type']"
                  mode="keep-value-property"
                  priority="8"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:string[@key='uuid']"
                  priority="6"><!-- XML match="system-security-plan/metadata/party/@uuid" -->
      <flag in-json="string"
             as-type="uuid"
             name="uuid"
             key="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:string[@key='uuid']"
                  mode="keep-value-property"
                  priority="6"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:string[@key='type']"
                  priority="6"><!-- XML match="system-security-plan/metadata/party/@type" -->
      <flag in-json="string"
             as-type="string"
             name="type"
             key="type"
   ...
   <xsl:template match="j:array[@key='actions']/j:map/j:string[@key='system']"
                  mode="keep-value-property"
                  priority="6"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='import-profile']/j:string[@key='href']" priority="1"><!-- XML match="import-profile/@href" -->
      <flag in-json="string"
             as-type="uri-reference"
             name="href"
             key="href"
   ...
   <xsl:template match="j:array[@key='diagrams']/j:map/j:string[@key='uuid']"
                  priority="1"><!-- XML match="diagram/@uuid" -->
      <flag in-json="string"
             as-type="uuid"
             name="uuid"
             key="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='roles']/j:map"
                  priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="system-security-plan/metadata/role" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map"
                  priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="system-security-plan/metadata/location" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map"
                  priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="system-security-plan/metadata/party" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='actions']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                  priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="system-security-plan/metadata/action/link/text" -->
      <field collapsible="no"
              as-type="markup-line"
              name="text"
              key="text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='actions']/j:map/j:array[@key='responsible-parties']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                  priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="system-security-plan/metadata/action/responsible-party/link/text" -->
      <field collapsible="no"
              as-type="markup-line"
              name="text"
              key="text"
