...
<!-- JSON to XML conversion: pipeline -->
   ...
   <!-- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ -->
   <!-- METASCHEMA: OSCAL Profile Model (version 1.2.3) in namespace "http://csrc.nist.gov/ns/oscal/1.0"-->
   ...
   <xsl:template match="j:map[@key='profile']/j:string[@key='uuid']" priority="1"><!-- XML match="profile/@uuid" -->
      <flag in-json="string"
             as-type="uuid"
             name="uuid"
             key="uuid"
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='roles']/j:map/j:string[@key='id']"
                  priority="6"><!-- XML match="profile/metadata/role/@id" -->
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='roles']/j:map/j:string[@key='id']"
                  mode="keep-value-property"
                  priority="6"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:string[@key='uuid']"
                  priority="6"><!-- XML match="profile/metadata/location/@uuid" -->
      <flag in-json="string"
             as-type="uuid"
             name="uuid"
             key="uuid"
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:array[@key='telephone-numbers']/j:map/j:string[@key='type'] | j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:array[@key='telephone-numbers']/j:map/j:string[@key='type']"
                  mode="keep-value-property"
                  priority="8"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:string[@key='uuid']"
                  priority="6"><!-- XML match="profile/metadata/party/@uuid" -->
      <flag in-json="string"
             as-type="uuid"
             name="uuid"
             key="uuid"
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:string[@key='uuid']"
                  mode="keep-value-property"
                  priority="6"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:string[@key='type']"
                  priority="6"><!-- XML match="profile/metadata/party/@type" -->
      <flag in-json="string"
             as-type="string"
             name="type"
             key="type"
   ...
   <xsl:template match="j:array[@key='imports']/j:map/j:string[@key='href']"
                  priority="1"><!-- XML match="import/@href" -->
      <flag in-json="string"
             as-type="uri-reference"
             name="href"
             key="href"
   ...
   <xsl:template match="j:array[@key='insert-controls']/j:map/j:string[@key='order']"
                  priority="1"><!-- XML match="insert-controls/@order" -->
      <flag in-json="string"
             as-type="token"
             name="order"
             key="order"
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='modify']/j:array[@key='set-parameters']/j:map/j:string[@key='depends-on']"
                  priority="6"><!-- XML match="profile/modify/set-parameter/@depends-on" -->
      <flag in-json="string"
             as-type="token"
             name="depends-on"
             key="depends-on"
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='roles']/j:map"
                  priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="profile/metadata/role" -->
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='locations']/j:map"
                  priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="profile/metadata/location" -->
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='parties']/j:map"
                  priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="profile/metadata/party" -->
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='actions']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                  priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="profile/metadata/action/link/text" -->
      <field collapsible="no"
              as-type="markup-line"
              name="text"
              key="text"
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='metadata']/j:array[@key='actions']/j:map/j:array[@key='responsible-parties']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                  priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="profile/metadata/action/responsible-party/link/text" -->
      <field collapsible="no"
              as-type="markup-line"
              name="text"
              key="text"
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='merge']/j:map[@key='combine']"
                  priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="profile/merge/combine" -->
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='merge']/j:map[@key='flat']"
                  priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="profile/merge/flat" -->
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='merge']/j:boolean[@key='as-is']"
                  priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="profile/merge/as-is" -->
      <field collapsible="no"
              as-type="boolean"
              name="as-is"
              key="as-is"
   ...
   <xsl:template match="j:map[@key='profile']/j:map[@key='merge']/j:map[@key='custom']"
                  priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="profile/merge/custom" -->
   ...
   <xsl:template priority="6"
      ...
      <field scope="local"
              _step="prose"
              _key="prose"
              _metaschema-xml-id="/assembly/oscal-control-common/parameter-guideline/prose"
              _metaschema-json-id="/assembly/oscal-control-common/parameter-guideline/prose"
              in-xml="UNWRAPPED"
              collapsible="no"
              as-type="markup-multiline"
              name="prose"
